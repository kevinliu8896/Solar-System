...
public class CodeLab8 extends JPanel {
    ...
    private static TransformGroup createBox() {
        ...
        TransparentCollisionDetectColumns tcdc = new TransparentCollisionDetectColumns(colorCube); // create a Transparent collisionn detection for columns
    ...
    public static BranchGroup createScene() {
        ...
        scene.addChild(CommonsKL.rotateBehavior(10000, sceneTG));
    ...
    public static void main(String[] args) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new CommonsKL.MyGUI(createScene(), "KL's Lab8");
            }
        });
    }
}