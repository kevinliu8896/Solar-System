...
public class CodeAssign5 extends JPanel implements ActionListener {
    ...
    public CodeAssign5() {
        ...
        t3d.setTranslation(new Vector3d(0, 0, -13));   // viewer looking down from top change z to -13
        t3d.invert();
        ...
        lcl.addBranchGraph(createViewer(canvas3D[1], "F-L", CommonsKL.Orange, -3.5, 1, 3.5));
        lcl.addBranchGraph(createViewer(canvas3D[2], "B-R", CommonsKL.Cyan, 3.5, 1, -3.5));

        BranchGroup scene = CodeAssign5b.createScene();                  // create a one-cube scene
        TransformGroup scene_TG = new TransformGroup();
        scene.addChild(scene_TG);
        CodeAssign5b.addLights(scene, CommonsKL.White);
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("KL's Assignment 5");
