...
public class CommonsKL extends JPanel {
    ...
    public CommonsKL(BranchGroup sceneBG) {
        createUniverse();
        if (k_tag == true)
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(new CommonsKL(createScene()));
    }
    ...
    public static class MyGUI extends JFrame {
        ...
        public MyGUI(BranchGroup branchGroup, String title) {
            ...
            frame.getContentPane().add(new CommonsKL(branchGroup));
            pack();
        }
    }
